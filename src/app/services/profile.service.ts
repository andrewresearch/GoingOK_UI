...
import {ReflectionEntry, Profile} from "../store/models";
import {Gok} from './gok.globals';
import {AuthenticationService} from "./authentication.service";
import {ResearchChoice} from "../store/models/ResearchParticipation";
...
export class ProfileService {
    ...
    extractProfile = (response:Response): Profile => {
        //console.log("Extracting profile from response: "+JSON.stringify(response));
